...
## Installing R on...
### Windows  
* Just go to **[the cran.r site](https://cran.r-project.org/)** and install the Windows version.  
...
### Mac  
* Just go to **[the cran.r site](https://cran.r-project.org/)** and install the Mac version.  
